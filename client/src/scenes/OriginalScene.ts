...
export class GameScene extends Phaser.Scene {
    ...
    // inputBuffer: Array<typeof this.inputPayload> = [];
    ...
    async connect() {
        ...
        try {
            ...
            // couldn't connect
            this.add.text(0, 0, "Could not connect with the server.", { color: "#ff0000" });
        }
    ...
    fixedTick(time, delta) {
        ...
        // console.log({
        //     localTick: this.currentTick,
        //     remoteTick: currentPlayerRemote.tick,
        //     behind: 
        // });
